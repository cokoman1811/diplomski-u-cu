...
| block | none | 40% | cubic_interpolation | 1.1448 | 1.3846 | 0.2281 | 115 | 115 |
...
| block | none | 50% | cubic_interpolation | 1.8066 | 2.3389 | -8.1505 | 144 | 144 |
...
| block | none | 80% | cubic_interpolation | 1.8286 | 2.2011 | -0.1747 | 230 | 230 |
...
| block_end | end | 10% | cubic_interpolation | 0.2195 | 0.2765 | 0.6707 | 29 | 29 |
...
| block_end | end | 20% | cubic_interpolation | 0.4108 | 0.4501 | 0.5516 | 58 | 58 |
...
| block_end | end | 30% | cubic_interpolation | 0.6671 | 0.7697 | -0.4063 | 86 | 86 |
...
| block_end | end | 40% | cubic_interpolation | 2.9237 | 3.2509 | -17.3551 | 115 | 115 |
...
| block_end | end | 50% | cubic_interpolation | 6.3491 | 6.9499 | -79.2497 | 144 | 144 |
...
| block_end | end | 60% | cubic_interpolation | 0.7227 | 0.8186 | -0.0491 | 173 | 173 |
...
| block_end | end | 70% | cubic_interpolation | 2.6468 | 3.1874 | -11.4000 | 202 | 202 |
...
| block_end | end | 80% | cubic_interpolation | 6.4665 | 7.3344 | -35.1676 | 230 | 230 |
...
| block_start | start | 10% | cubic_interpolation | 0.5369 | 0.6085 | -0.3880 | 29 | 29 |
...
| block_start | start | 20% | cubic_interpolation | 0.9311 | 1.0954 | -1.2504 | 58 | 58 |
...
| block_start | start | 30% | cubic_interpolation | 0.9713 | 1.1943 | -0.0214 | 86 | 86 |
...
| block_start | start | 40% | cubic_interpolation | 2.2900 | 2.5576 | -1.7108 | 115 | 115 |
...
| block_start | start | 50% | cubic_interpolation | 1.1219 | 1.4115 | 0.3497 | 144 | 144 |
...
| block_start | start | 60% | cubic_interpolation | 3.0857 | 3.6795 | -3.1269 | 173 | 173 |
...
| block_start | start | 70% | cubic_interpolation | 2.1933 | 2.3259 | -0.6166 | 202 | 202 |
...
| block_start | start | 80% | cubic_interpolation | 0.8830 | 1.1028 | 0.6945 | 230 | 230 |
...
| random | none | 40% | cubic_interpolation | 0.0849 | 0.1421 | 0.9953 | 115 | 115 |
...
| random | none | 50% | cubic_interpolation | 0.0788 | 0.1304 | 0.9958 | 144 | 144 |
...
| random | none | 60% | cubic_interpolation | 0.0876 | 0.1321 | 0.9960 | 173 | 173 |
...
| random | none | 70% | cubic_interpolation | 0.0913 | 0.1365 | 0.9956 | 202 | 202 |
...
| random | none | 80% | cubic_interpolation | 0.1056 | 0.1567 | 0.9944 | 230 | 230 |
...
| 40% | cubic_interpolation | 0.0849 | 0.1421 | 0.9953 | 115 | 115 |
...
| 50% | cubic_interpolation | 0.0788 | 0.1304 | 0.9958 | 144 | 144 |
...
| 60% | cubic_interpolation | 0.0876 | 0.1321 | 0.9960 | 173 | 173 |
...
| 70% | cubic_interpolation | 0.0913 | 0.1365 | 0.9956 | 202 | 202 |
...
| 80% | cubic_interpolation | 0.1056 | 0.1567 | 0.9944 | 230 | 230 |
...
| cubic_interpolation | 0.0406 | 0.0488 | 0.0448 | 0.0849 | 0.0788 | 0.0876 | 0.0913 | 0.1056 |
...
| cubic_interpolation | 0.0503 | 0.0672 | 0.0606 | 0.1421 | 0.1304 | 0.1321 | 0.1365 | 0.1567 |
...
| cubic_interpolation | 0.9993 | 0.9987 | 0.9991 | 0.9953 | 0.9958 | 0.9960 | 0.9956 | 0.9944 |
...
| 40% | cubic_interpolation | 1.1448 | 1.3846 | 0.2281 | 115 | 115 |
...
| 50% | cubic_interpolation | 1.8066 | 2.3389 | -8.1505 | 144 | 144 |
...
| 80% | cubic_interpolation | 1.8286 | 2.2011 | -0.1747 | 230 | 230 |
...
| cubic_interpolation | 0.3391 | 0.1946 | 0.4890 | 1.1448 | 1.8066 | 1.8053 | 1.7745 | 1.8286 |
...
| cubic_interpolation | 0.3654 | 0.2737 | 0.5492 | 1.3846 | 2.3389 | 2.2680 | 2.0544 | 2.2011 |
...
| cubic_interpolation | -2.3624 | 0.9155 | 0.5995 | 0.2281 | -8.1505 | -3.0313 | -1.7625 | -0.1747 |
...
| 10% | cubic_interpolation | 0.5369 | 0.6085 | -0.3880 | 29 | 29 |
...
| 20% | cubic_interpolation | 0.9311 | 1.0954 | -1.2504 | 58 | 58 |
...
| 30% | cubic_interpolation | 0.9713 | 1.1943 | -0.0214 | 86 | 86 |
...
| 40% | cubic_interpolation | 2.2900 | 2.5576 | -1.7108 | 115 | 115 |
...
| 50% | cubic_interpolation | 1.1219 | 1.4115 | 0.3497 | 144 | 144 |
...
| 60% | cubic_interpolation | 3.0857 | 3.6795 | -3.1269 | 173 | 173 |
...
| 70% | cubic_interpolation | 2.1933 | 2.3259 | -0.6166 | 202 | 202 |
...
| 80% | cubic_interpolation | 0.8830 | 1.1028 | 0.6945 | 230 | 230 |
...
| cubic_interpolation | 0.5369 | 0.9311 | 0.9713 | 2.2900 | 1.1219 | 3.0857 | 2.1933 | 0.8830 |
...
| cubic_interpolation | 0.6085 | 1.0954 | 1.1943 | 2.5576 | 1.4115 | 3.6795 | 2.3259 | 1.1028 |
...
| cubic_interpolation | -0.3880 | -1.2504 | -0.0214 | -1.7108 | 0.3497 | -3.1269 | -0.6166 | 0.6945 |
...
| 10% | cubic_interpolation | 0.2195 | 0.2765 | 0.6707 | 29 | 29 |
...
| 20% | cubic_interpolation | 0.4108 | 0.4501 | 0.5516 | 58 | 58 |
...
| 30% | cubic_interpolation | 0.6671 | 0.7697 | -0.4063 | 86 | 86 |
...
| 40% | cubic_interpolation | 2.9237 | 3.2509 | -17.3551 | 115 | 115 |
...
| 50% | cubic_interpolation | 6.3491 | 6.9499 | -79.2497 | 144 | 144 |
| 50% | spline_interpolation | 6.3491 | 6.9499 | -79.2497 | 144 | 144 |
| 60% | cubic_interpolation | 0.7227 | 0.8186 | -0.0491 | 173 | 173 |
...
| 70% | cubic_interpolation | 2.6468 | 3.1874 | -11.4000 | 202 | 202 |
...
| 80% | cubic_interpolation | 6.4665 | 7.3344 | -35.1676 | 230 | 230 |
...
| cubic_interpolation | 0.2195 | 0.4108 | 0.6671 | 2.9237 | 6.3491 | 0.7227 | 2.6468 | 6.4665 |
...
| cubic_interpolation | 0.2765 | 0.4501 | 0.7697 | 3.2509 | 6.9499 | 0.8186 | 3.1874 | 7.3344 |
...
| cubic_interpolation | 0.6707 | 0.5516 | -0.4063 | -17.3551 | -79.2497 | -0.0491 | -11.4000 | -35.1676 |
...
| random | none | 30% | cubic_interpolation | 0.0448 | 0.0606 | 0.9991 |
...
| block_start | start | 30% | cubic_interpolation | 0.9713 | 1.1943 | -0.0214 |
...
| block_end | end | 10% | linear_interpolation | 0.1970 | 0.2523 | 0.7258 |
| block_end | end | 20% | linear_interpolation | 0.3538 | 0.3940 | 0.6565 |
| block_end | end | 30% | cubic_interpolation | 0.6671 | 0.7697 | -0.4063 |
| block_end | end | 40% | random_forest | 1.0260 | 1.2487 | -1.7082 |
| block_end | end | 50% | decision_tree | 0.8176 | 1.0873 | -0.9642 |
| block_end | end | 60% | cubic_interpolation | 0.7227 | 0.8186 | -0.0491 |

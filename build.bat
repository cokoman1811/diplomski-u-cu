...
"%GCC%" -std=c99 -O2 -Wall -Wextra -Isrc tests\run_tests.c src\dataset.c src\evaluation.c src\interpolation.c src\ml_methods.c src\preprocessing.c -o tests.exe -lm
if errorlevel 1 (

...
"%GCC%" -std=c99 -O2 -Wall -Wextra -Isrc tests\run_tests.c src\dataset.c src\decision_tree.c src\evaluation.c src\interpolation.c src\adaptive_imputation.c src\knn_methods.c src\knn_upgraded.c src\rf_methods.c src\neural_net.c src\gap_features.c src\ml_features.c src\preprocessing.c -o tests.exe -lm
if errorlevel 1 (
